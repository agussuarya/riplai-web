  ...
  return (
    <div className="doc-layout">
      ...
      <div className="doc-body">
        ...
        <Section id="s1" title={<>1. Penerimaan &amp; Definisi <span style={{ fontSize: '13px', fontWeight: 400, color: 'var(--text-3)' }}>(Acceptance &amp; Definitions)</span></>} open={!!open['s1']} onToggle={() => toggle('s1')}>
        ...
        <Section id="s2" title={<>2. Deskripsi Layanan <span style={{ fontSize: '13px', fontWeight: 400, color: 'var(--text-3)' }}>(Service Description)</span></>} open={!!open['s2']} onToggle={() => toggle('s2')}>
        ...
        <Section id="s3" title={<>3. Kelayakan &amp; Akun <span style={{ fontSize: '13px', fontWeight: 400, color: 'var(--text-3)' }}>(Eligibility &amp; Account)</span></>} open={!!open['s3']} onToggle={() => toggle('s3')}>
        ...
        <Section id="s4" title={<>4. Kewajiban &amp; Larangan Pengguna <span style={{ fontSize: '13px', fontWeight: 400, color: 'var(--text-3)' }}>(User Obligations &amp; Prohibited Use)</span></>} open={!!open['s4']} onToggle={() => toggle('s4')}>
        ...
        <Section id="s5" title={<>5. Pembayaran &amp; Berlangganan <span style={{ fontSize: '13px', fontWeight: 400, color: 'var(--text-3)' }}>(Payment &amp; Subscription)</span></>} open={!!open['s5']} onToggle={() => toggle('s5')}>
          ...
          <ul className="doc-ul">
            ...
            <li><strong>Perubahan harga:</strong> Harga berlangganan dapat berubah dengan pemberitahuan minimal <strong>30 hari</strong> melalui email terdaftar.</li>
          </ul>
        ...
        <Section id="s6" title={<>6. Kekayaan Intelektual <span style={{ fontSize: '13px', fontWeight: 400, color: 'var(--text-3)' }}>(Intellectual Property)</span></>} open={!!open['s6']} onToggle={() => toggle('s6')}>
        ...
        <Section id="s7" title={<>7. Pembatasan Tanggung Jawab <span style={{ fontSize: '13px', fontWeight: 400, color: 'var(--text-3)' }}>(Limitation of Liability)</span></>} open={!!open['s7']} onToggle={() => toggle('s7')}>
        ...
        <Section id="s8" title={<>8. Penangguhan &amp; Penghentian <span style={{ fontSize: '13px', fontWeight: 400, color: 'var(--text-3)' }}>(Suspension &amp; Termination)</span></>} open={!!open['s8']} onToggle={() => toggle('s8')}>
        ...
        <Section id="s9" title={<>9. Hukum yang Berlaku &amp; Penyelesaian Sengketa <span style={{ fontSize: '13px', fontWeight: 400, color: 'var(--text-3)' }}>(Governing Law &amp; Disputes)</span></>} open={!!open['s9']} onToggle={() => toggle('s9')}>
