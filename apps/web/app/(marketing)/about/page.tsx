export default function AboutPage() {
  return (
    <div className="max-w-[800px] mx-auto px-5 md:px-12 py-14">
      ...
      <p
        className="text-[var(--text-2)] leading-[1.65] max-w-[560px] mb-12"
        style={{ fontSize: '17px' }}
      >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5 mb-12">
        <div className="text-center bg-[var(--bg-surface)] border border-[var(--border)] rounded-[18px] p-7">
          <p className="font-extrabold text-brand-500" style={{ fontSize: '32px' }}>
            200+
          </p>
          <p className="text-[var(--text-2)] font-medium mt-1.5" style={{ fontSize: '13.5px' }}>
            Bisnis aktif
          </p>
        </div>
        <div className="text-center bg-[var(--bg-surface)] border border-[var(--border)] rounded-[18px] p-7">
      ...
      {/* Misi */}
      <div className="bg-[var(--bg-surface)] border border-[var(--border)] rounded-[18px] p-7 mb-6">
        <h2 className="font-bold text-[var(--text-1)] mb-3" style={{ fontSize: '18px' }}>
          Misi kami
        </h2>
      ...
      <div className="bg-[var(--bg-surface)] border border-[var(--border)] rounded-[18px] p-7">
        <h2 className="font-bold text-[var(--text-1)] mb-4" style={{ fontSize: '18px' }}>
          Informasi Perusahaan
        </h2>
        <div className="space-y-3">
          <div className="flex gap-3">
            <span
              className="font-semibold text-[var(--text-3)] shrink-0"
              style={{ fontSize: '13px', width: '140px' }}
            >
              Pengelola
            </span>
            <span className="text-[var(--text-1)]" style={{ fontSize: '13px' }}>
