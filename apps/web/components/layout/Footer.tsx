...
export function Footer() {
  return (
    <footer className="bg-[#0D1117] text-white py-11 px-12">
      <div className="max-w-[1100px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          <div className="md:col-span-1">
            <RiplaiLogo size={28} variant="white" />
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="/demo" className="text-sm text-gray-500 hover:text-white transition-colors">
                  Demo
                </a>
              </li>
            </ul>
